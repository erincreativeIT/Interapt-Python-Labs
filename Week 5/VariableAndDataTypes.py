...
num1 = 100
num2 = 3.14159
#:.5f is the amount of decimal points (floating point)
print( f'{num1} multiple by {num2} = {num1 * num2:.5f} ')
print( f'The type of {num1} is {type( num1 ) }')
print( f'The type of {num2} is {type( num2 ) }')
#the id function will output the unique identifer to 100 and 3.14159 (num1 and num2)
print( f'The unique object identifer of {num1} is {id( num1 ) }')
...
# Verify that Python assigns a different object reference to # num1 and num2 than it had before the arithhmetic.
